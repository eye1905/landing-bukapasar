...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <div id="logo">
        <h1><a href="index.html"><span>B</span>ukapasar.id</a></h1>
      </div>
  ...
  <section id="hero">
    <div class="hero-container" data-aos="fade-in">
      ...
      <img src="landing/assets/img/bg1.jpg" alt="Hero Imgs" data-aos="zoom-out" data-aos-delay="100">
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-4" data-aos="zoom-in" data-aos-delay="100">
            <div class="feature-block">
              ...
              <img src="landing/assets/img/svg/cloud.svg" alt="img">
          ...
          <div class="col-md-6 col-lg-4" data-aos="zoom-in" data-aos-delay="200">
            <div class="feature-block">
              ...
              <img src="landing/assets/img/svg/planet.svg" alt="img">
          ...
          <div class="col-md-6 col-lg-4" data-aos="zoom-in" data-aos-delay="300">
            <div class="feature-block">
              ...
              <img src="landing/assets/img/svg/asteroid.svg" alt="img">
      ...
      <div class="container" data-aos="fade-up">
        <div class="row justify-content-center">
          ...
          <div class="col-md-5 col-lg-3">
            <img src="landing/assets/img/about-img.png" alt="About" data-aos="zoom-in" data-aos-delay="100">
          </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="col-md-6 col-lg-3">
            <div class="feature-block">
              <img src="landing/assets/img/svg/paint-palette.svg" alt="img">
          ...
          <div class="col-md-6 col-lg-3">
            <div class="feature-block">
              <img src="landing/assets/img/svg/vector.svg" alt="img">
              <h4>Retina Ready</h4>
              <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry</p>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-3">
            <div class="feature-block">
              <img src="landing/assets/img/svg/design-tool.svg" alt="img">
              <h4>easy to use</h4>
              <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry</p>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-3">
            <div class="feature-block">
              <img src="landing/assets/img/svg/cloud-computing.svg" alt="img">
          ...
          <div class="col-md-6 col-lg-3">
            <div class="feature-block">
              <img src="landing/assets/img/svg/pixel.svg" alt="img">
              <h4>Perfect Pixel</h4>
              <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry</p>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-3">
            <div class="feature-block">
              <img src="landing/assets/img/svg/code.svg" alt="img">
              <h4>clean codes</h4>
              <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry</p>
            </div>
          </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="screens-slider swiper">
          <div class="swiper-wrapper align-items-center">
            <div class="swiper-slide"><img src="landing/assets/img/screen/1.jpg" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="landing/assets/img/screen/2.jpg" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="landing/assets/img/screen/3.jpg" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="landing/assets/img/screen/4.jpg" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="landing/assets/img/screen/5.jpg" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="landing/assets/img/screen/6.jpg" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="landing/assets/img/screen/7.jpg" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="landing/assets/img/screen/8.jpg" class="img-fluid" alt=""></div>
          </div>
  ...
  <footer class="footer">
    ...
    <div class="copyrights">
      <div class="container">
        ...
        -->
          Designed by <a href="https://Infinitedev.id/">Infinitedev.id</a>
        </div>
      </div>
    </div>
